...
import 'package:menarmed_mobile/repository/suggestion_repo.dart';
...
class ReportSuggestionScreen extends StatefulWidget {
  ...
  @override
  State<ReportSuggestionScreen> createState() => _ReportSuggestionScreenState();
}

class _ReportSuggestionScreenState extends State<ReportSuggestionScreen> {
  List _reportList = [];
    ...
    return ListView(
      ...
      children: _reportList.map((value) {
        return Container(
          ...
          decoration: const BoxDecoration(border: Border(bottom: BorderSide(width: 1, color: bgLightPrimary))),
          child: Column(

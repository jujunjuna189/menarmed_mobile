...
import 'package:menarmed_mobile/repository/profile_repo.dart';
import 'package:menarmed_mobile/utils/colors.dart';
import 'package:menarmed_mobile/widgets/text_field/field_date.dart';
import 'package:menarmed_mobile/widgets/text_field/field_text.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _nameController, placeHolder: "Nama Lengkap ...", border: false,),
                ),
              ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _pangkatController, placeHolder: "Pangkat ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _korpController, placeHolder: "Korp ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _satuanController, placeHolder: "Satuan ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _tempatLahirController, placeHolder: "Tempat Lahir...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldDate(controller: _tglLahirController, placeHolder: "Tanggal Lahir...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _agamaController, placeHolder: "Agama ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _golDarahController, placeHolder: "Golongan Darah ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _sumberPaController, placeHolder: "Sumber Pa ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _jabatanController, placeHolder: "Jabatan ...", border: false),
                ),
              ),
              const SizedBox(height: 10,),
              Padding(
                ...
                child: Container(
                  ...
                  child: FieldText(controller: _senjataController, placeHolder: "Senjata ...", border: false),
                ),
              ),
            ],
          ),
